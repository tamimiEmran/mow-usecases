...
Usage:
    ...
    MODEL=llava-hf/llava-v1.6-mistral-7b-hf python app/main.py
"""
...
def main():
    ...
    logger.info("  Full video dir: %s", settings.storage.full_video_dir)
    ...
    app.launch(
        ...
        allowed_paths=[
            ...
            settings.storage.video_dir,
            settings.storage.full_video_dir,
        ],
    )
